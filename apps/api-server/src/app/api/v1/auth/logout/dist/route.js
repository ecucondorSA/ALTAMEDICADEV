...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var authHeader, idToken, decodedToken, uid, responseData, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, firebase_1.adminAuth.revokeRefreshTokens(uid)];
                case 2:
                    // Revoke refresh tokens for the user
                    _a.sent();
                    responseData = {
                ...
                case 3:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json(shared_1.createErrorResponse('LOGOUT_FAILED', 'Error en el logout'), { status: 500 })];
